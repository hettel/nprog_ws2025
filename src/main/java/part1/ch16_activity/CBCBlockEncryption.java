...
public class CBCBlockEncryption 
{
	...
	private static class Encrypter implements Runnable
	{
		...
		public Encrypter(int initVector, int shift, BlockingQueue<Optional<Integer>> inQueue, BlockingQueue<Optional<Integer>> outQueue) {
			super();
	...
	public static void main(String[] args) throws Exception
	{
		...
		Encrypter encrypter = new Encrypter(InitVector, CaesarShift,queueProd2Enrcpt, queueEncrypt2Consumer);
